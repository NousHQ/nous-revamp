          ...
          <ContextMenu key={item.id}>
            <ContextMenuTrigger>
              <div className="text-xs flex justify-between items-center w-full pr-4">
                <a
                  className="w-full py-3 relative rounded-lg flex items-end justify-start gap-3 font-medium text-green-12 hover:bg-green-3"
                  href={item.url}
                  target="_blank"
                >
            ...
            <ContextMenuContent className="bg-green-1">
              <ContextMenuItem>
                <form action={deleteData} className="w-full">
                  ...
                  <button
                    type="submit"
                    className="flex items-center justify-center text-xs text-green-12 bg-green-1 gap-3 rounded-lg w-full"
                  >
                    <Image
                      src={trash}
                      alt="Delete"
                      className="text-green-12 h-3 w-3"
                    />
                    Delete
                  </button>
                </form>
